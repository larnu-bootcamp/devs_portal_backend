...
export class tables1666471139730 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query('CREATE TABLE "user" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "last_name" character varying NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, "active" boolean NOT NULL, "role" character varying NOT NULL, CONSTRAINT "UQ_0d41e4ba286d04881756d625ebd" UNIQUE ("email"), CONSTRAINT "PK_7b1706f6f2f543c10c3f2e79754" PRIMARY KEY ("id"))');
  }
